#!/usr/bin/env python3
"""
Hook SessionEnd du Claude Brain — maintenance AUTONOME complète (phase 2).
...
def launch_agent(sid, n, to_distill):
    ...
    garden_task = (
        "Vide l'Inbox de MEMORY.md, range chaque fiche dans la bonne section, "
    ...
    # commit MÉCANIQUE (pas de LLM) : auteur « Claude Brain », ne casse jamais si rien à committer.
    ...
    # hors-index) JUSTE APRÈS lui, et trace le verdict dans gardening.log. Il ne corrige
